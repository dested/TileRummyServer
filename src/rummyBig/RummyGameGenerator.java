...
/*
 *  produce a RummyGame grid
 *  @author: Paul-benoit Larochelle
 */
public class RummyGameGenerator {
	...
	// size of the RummyGame grid is received as parameter
	// actually not the size of the grid but the size of the region
	public RummyGameGenerator(int size) {
		regionSize = size;
		this.size = size * size;
	...
	public static void main(String[] arg) {
		RummyGameGenerator s = new RummyGameGenerator(3);
		s.generate(true);
		System.out.print(s);
	}
}
